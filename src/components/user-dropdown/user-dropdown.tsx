...
export default component$((props: DropdownProps) => {
  ...
  return (
    <div class="relative inline-block text-left">
      ...
      <div
        class={`absolute right-0 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none transition ${
          isOpen.value
      ...
      >
        <div role="none">
          <div class="py-3 px-5 bg-primary bg-opacity-20 rounded-t-lg">
            ...
            <p class="text-sm font-medium text-quaternary truncate">{email}</p>
          </div>
          <div class="mb-2 mt-2">
            ...
            <button
              class="text-text block px-4 py-2 text-sm font-medium hover:bg-primary hover:bg-opacity-10 text-left w-full"
              onClick$={async () => {
                try {
